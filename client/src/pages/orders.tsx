    ...
    <div className="flex-1 flex flex-col">
      ...
      <div className="flex-1 p-6 space-y-6">
        ...
        <Dialog open={isModalOpen} onOpenChange={handleCloseModal}>
          <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto sm:block hidden" data-testid="modal-create-order">
            <DialogHeader>
        ...
        {/* Mobile Drawer for Order Creation */}
        <Drawer open={isModalOpen} onOpenChange={handleCloseModal}>
          <DrawerContent className="sm:hidden max-h-[90vh] overflow-y-auto" data-testid="modal-create-order-mobile">
            <DrawerHeader>
              <DrawerTitle>{t('createNewOrder')}</DrawerTitle>
            </DrawerHeader>
