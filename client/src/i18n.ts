...
const resources = {
  en: {
    translation: {
      ...
      readyToBuyDescription: "Orders ready for purchasing - awaiting down payment collection",
      readyToBuyOrders: "Ready to Buy Orders",
      noReadyToBuyOrders: "No ready to buy orders",
      bought: "Bought",
      orderMarkedAsProcessing: "Order marked as processing",
      failedToUpdateOrderStatus: "Failed to update order status",
      sentOrdersAwaitingPayment: "Sent Orders - Awaiting Down Payment Collection",
      ordersWithDownPayment: "Orders sent to Darb Assabil that have down payment to collect",
      paymentCollected: "Payment Collected",
      downPaymentCollected: "Down payment collected, order moved to Ready to Buy",
      reference: "Reference",
      ...
      unitPriceDollar: "Price After Discount ($)",
      ...
      product: "Product",
      unitPriceLabel: "Price After Discount",
      ...
      unitPrice: "Price After Discount",
      supplier: "Supplier",
      category: "Category",
      ...
      commissionRulesFromSettings: "Commission rules from your settings",
      range: "Range",
      totalCommissionRules: "Total of {{count}} commission rules",
      noCommissionRules: "No Commission Rules",
      addCommissionRulesInSettings: "Add commission rules in settings to see them here",
      basedOnOrders: "Based on {{count}} orders",
      ...
      numberOfDiscountedOrders: "Number of Discounted Orders",
      ordersWithDownPayments: "Orders with down payments made",
      profitGeneratedPerOrder: "Profit generated per order on average",
      averageUsdToLydRate: "Average USD to LYD conversion rate",
      generatedIn: "Generated",
      inRevenue: "in revenue with",
      fromOrdersCount: "from",
      ordersLabel: "orders",
      ordersIncreased: "increased",
      ordersDecreased: "decreased",
      by: "by",
      salesGrew: "grew",
      salesDeclined: "declined",
      profitImproved: "improved",
      profitDropped: "dropped",
      strongProfitGrowth: "Strong profit growth indicates healthy business performance",
      ofOrdersIncludedDownPayments: "of orders included down payments",
      reviewPricingStrategy: "Review pricing strategy to improve profit margins",
      ...
      lydExchangeRateSetting: "LYD Sale Exchange Rate",
      lydExchangeRateDesc: "Set the exchange rate at which you SELL USD to customers (in LYD)",
      enterExchangeRate: "Enter sale exchange rate (USD to LYD)",
      exchangeRateUpdated: "Sale exchange rate updated successfully",
      failedUpdateExchangeRate: "Failed to update exchange rate. Please try again.",
      enterValidExchangeRate: "Please enter a valid exchange rate greater than 0",
      currentExchangeRate: "Current Exchange Rate",
      currentSaleRate: "Current Sale Rate",
      lydPurchaseExchangeRateSetting: "LYD Purchase Exchange Rate",
      lydPurchaseExchangeRateDesc: "Set the exchange rate at which you BUY USD (your cost in LYD)",
      enterPurchaseExchangeRate: "Enter purchase exchange rate (USD to LYD)",
      purchaseExchangeRateUpdated: "Purchase exchange rate updated successfully",
      failedUpdatePurchaseExchangeRate: "Failed to update purchase exchange rate. Please try again.",
      enterValidPurchaseExchangeRate: "Please enter a valid purchase exchange rate greater than 0",
      currentPurchaseRate: "Current Purchase Rate",
      exchangeRateProfit: "Exchange Rate Profit Margin",
      profitPerUSD: "Profit per USD",
      exchangeRateProfitDesc: "This is your profit from currency exchange on each USD",
      ...
      taskTypeTask: "Task",
      taskTypeReceivePayment: "Receive Payment",
      taskTypeReceiveShipments: "Receive Shipments",
      ...
      taskAddress: "Address",
      enterTaskAddress: "Enter address",
      taskValue: "Value ($)",
      enterTaskValue: "Enter value",
      taskWeight: "Weight (kg)",
      enterTaskWeight: "Enter weight",
  ...
  ar: {
    translation: {
      ...
      readyToBuyDescription: "الطلبات الجاهزة للشراء - في انتظار تحصيل الدفعة المقدمة",
      readyToBuyOrders: "طلبات جاهزة للشراء",
      noReadyToBuyOrders: "لا توجد طلبات جاهزة للشراء",
      bought: "تم الشراء",
      orderMarkedAsProcessing: "تم تحديد الطلب كقيد المعالجة",
      failedToUpdateOrderStatus: "فشل في تحديث حالة الطلب",
      sentOrdersAwaitingPayment: "الطلبات المرسلة - في انتظار تحصيل الدفعة المقدمة",
      ordersWithDownPayment: "الطلبات المرسلة إلى درب الصابيل والتي لديها دفعة مقدمة للتحصيل",
      paymentCollected: "تم التحصيل",
      downPaymentCollected: "تم تحصيل الدفعة المقدمة، تم نقل الطلب إلى جاهز للشراء",
      reference: "المرجع",
      ...
      unitPriceDollar: "السعر بعد الخصم ($)",
      ...
      product: "المنتج",
      unitPriceLabel: "السعر بعد الخصم",
      ...
      commissionRulesFromSettings: "قواعد العمولة من إعداداتك",
      range: "النطاق",
      totalCommissionRules: "إجمالي {{count}} قواعد عمولة",
      noCommissionRules: "لا توجد قواعد عمولة",
      addCommissionRulesInSettings: "أضف قواعد العمولة في الإعدادات لرؤيتها هنا",
      basedOnOrders: "بناءً على {{count}} طلبات",
      ...
      detailedMetrics: "مقاييس تفصيلية",
      performanceSummary: "ملخص الأداء",
      revenueAndProfit: "الإيرادات والأرباح",
      growthTrends: "اتجاهات النمو",
      keyInsights: "رؤى رئيسية",
      recommendations: "توصيات",
      numberOfDiscountedOrders: "عدد الطلبات المخفضة",
      ordersWithDownPayments: "الطلبات التي تم دفع مقدم فيها",
      profitGeneratedPerOrder: "الربح المحقق لكل طلب في المتوسط",
      averageUsdToLydRate: "متوسط سعر التحويل من دولار إلى دينار",
      generatedIn: "تم تحقيق",
      inRevenue: "من الإيرادات مع",
      fromOrdersCount: "من",
      ordersLabel: "طلبات",
      ordersIncreased: "زيادة",
      ordersDecreased: "انخفاض",
      by: "بنسبة",
      salesGrew: "نمو",
      salesDeclined: "انخفاض",
      profitImproved: "تحسن",
      profitDropped: "انخفاض",
      strongProfitGrowth: "نمو قوي في الأرباح يشير إلى أداء تجاري صحي",
      ofOrdersIncludedDownPayments: "من الطلبات شملت دفعات مقدمة",
      reviewPricingStrategy: "مراجعة استراتيجية التسعير لتحسين هوامش الربح",
      ...
      lydExchangeRateSetting: "سعر صرف البيع بالدينار الليبي",
      lydExchangeRateDesc: "قم بتعيين سعر الصرف الذي تبيع به الدولار للعملاء (بالدينار الليبي)",
      enterExchangeRate: "أدخل سعر صرف البيع (الدولار إلى الدينار الليبي)",
      exchangeRateUpdated: "تم تحديث سعر صرف البيع بنجاح",
      failedUpdateExchangeRate: "فشل تحديث سعر الصرف. يرجى المحاولة مرة أخرى.",
      enterValidExchangeRate: "يرجى إدخال سعر صرف صالح أكبر من 0",
      currentExchangeRate: "سعر الصرف الحالي",
      currentSaleRate: "سعر البيع الحالي",
      lydPurchaseExchangeRateSetting: "سعر صرف الشراء بالدينار الليبي",
      lydPurchaseExchangeRateDesc: "قم بتعيين سعر الصرف الذي تشتري به الدولار (تكلفتك بالدينار الليبي)",
      enterPurchaseExchangeRate: "أدخل سعر صرف الشراء (الدولار إلى الدينار الليبي)",
      purchaseExchangeRateUpdated: "تم تحديث سعر صرف الشراء بنجاح",
      failedUpdatePurchaseExchangeRate: "فشل تحديث سعر صرف الشراء. يرجى المحاولة مرة أخرى.",
      enterValidPurchaseExchangeRate: "يرجى إدخال سعر صرف شراء صالح أكبر من 0",
      currentPurchaseRate: "سعر الشراء الحالي",
      exchangeRateProfit: "هامش ربح سعر الصرف",
      profitPerUSD: "الربح لكل دولار",
      exchangeRateProfitDesc: "هذا هو ربحك من صرف العملة على كل دولار",
      ...
      taskTypeTask: "مهمة",
      taskTypeReceivePayment: "استلام قيمة مالية",
      taskTypeReceiveShipments: "استلام شحنات",
      ...
      taskAddress: "العنوان",
      enterTaskAddress: "أدخل العنوان",
      taskValue: "القيمة ($)",
      enterTaskValue: "أدخل القيمة",
      taskWeight: "الوزن (كغ)",
      enterTaskWeight: "أدخل الوزن",
