...
const resources = {
  en: {
    translation: {
      ...
      lydExchangeRateSetting: "LYD Exchange Rate",
      lydExchangeRateDesc: "Set the exchange rate from USD to LYD for price calculations",
      enterExchangeRate: "Enter exchange rate (USD to LYD)",
  ...
  ar: {
    translation: {
      ...
      lydExchangeRateSetting: "سعر صرف الدينار الليبي",
      lydExchangeRateDesc: "قم بتعيين سعر الصرف من الدولار إلى الدينار الليبي لحساب الأسعار",
      enterExchangeRate: "أدخل سعر الصرف (الدولار إلى الدينار الليبي)",
